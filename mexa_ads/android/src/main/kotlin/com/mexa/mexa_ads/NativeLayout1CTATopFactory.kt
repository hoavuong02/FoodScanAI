...
class NativeLayout1CTATopFactory : GoogleMobileAdsPlugin.NativeAdFactory {
    ...
    override fun createNativeAd(
        ...
        val adView = layoutInflater.inflate(R.layout.native_layout_1_top_cta, null) as NativeAdView
