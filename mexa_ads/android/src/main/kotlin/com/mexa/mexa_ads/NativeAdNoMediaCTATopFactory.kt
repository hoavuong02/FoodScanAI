...
class NativeAdNoMediaCTATopFactory : GoogleMobileAdsPlugin.NativeAdFactory {
    ...
    override fun createNativeAd(
        ...
        val adView = layoutInflater.inflate(R.layout.native_ad_no_media_cta_top, null) as NativeAdView
